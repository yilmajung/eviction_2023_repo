...
summary(df2)
df2 <- cbind(df_np$case_number, df_np$eviction_rate, df2)
...
View(df_95ci)
write.csv(df_95ci, 'df_95ci_other_factors_mice.csv')
...
write.csv(df_np_geom, 'df_geom_other_factors_mice.csv')
